...
Set of additional skins for Shortcodes Ultimate. [Add-on page](https://getshortcodes.com/add-ons/additional-skins/).
...
* [Add-on documentation](http://docs.getshortcodes.com/category/30-additional-skins-add-on)

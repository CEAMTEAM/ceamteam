...
function optionsframework_options() {
	...
	$options[] = array( "name" => "Global Settings",
						"type" => "heading");
						
	$options[] = array( "name" => "Use this area to enter a message across all pages in the site",
						"desc" => "This will show up at the top of all existing sidebars",
						"type" => "info");
							
	$options[] = array( "name" => "Announcement Title",
						"desc" => "Announcement title goes here",
						"id" => "announcement_title_1",
						"std" => "",
						"type" => "text");
							
	$options[] = array( "name" => "Announcement",
						"desc" => "Announcement copy goes here",
						"id" => "announcement_copy_1",
						"std" => "",
						"type" => "textarea"); 


/*		
	$options[] = array( "name" => "Class Settings",
						"type" => "heading");
						
	$options[] = array( "name" => "Enter your class information here",

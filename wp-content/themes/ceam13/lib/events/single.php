...
<div id="tribe-events-event-meta"  class="line condensed" itemscope itemtype="http://schema.org/Event">
	<!-- 
	TITLE
	-->
	<h1 class="em3 m0 boxShadowBottom condensed" itemprop="name" class="event-meta event-meta-name"><?php the_title(); ?></h1>
	...
	<dl class="m0" itemprop="location" itemscope itemtype="http://schema.org/Place">
...
<div class="entry center size2of3 pad1to1">
	<?php //	if ( function_exists('has_post_thumbnail') && has_post_thumbnail() ) {  the_post_thumbnail(); } ?>
	<?php if(has_post_thumbnail()) { the_post_thumbnail('large', array('class' => 'borderLight'));} ?>
...
<?php endif; ?>
	...
	<ul class="bg line clear pt0 round">
		<li id="prev" class="p"> &laquo; Previous event: <?php tribe_previous_event_link(); ?></li>
		<li id="next" class="p"> &raquo; Next event: <?php tribe_next_event_link(); ?></li>
	</ul>
